...
![4cb3c8c607afc1d1582d](https://github.com/mohammedchakir/alx-backend-user-data/assets/129831433/0e0adf0d-2cec-4226-87c9-4e077a336dfa)
...
If the session ID is `Nonez or no user is found, return `None`. Otherwise return the corresponding user.
